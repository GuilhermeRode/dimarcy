...
class DashboardView(tk.Frame):
    ...
    def _build(self):
        ...
        btn_frame = tk.Frame(hdr, bg=CREME)
        btn_frame.pack(side="right")
        SecondaryBtn(btn_frame, "🏭  Nova produção",
                     command=self.app.nova_producao).pack(side="right", padx=(8, 0))
        PrimaryBtn(btn_frame, "＋  Novo pedido",
        ...
        rank_cols = [
            ("pos",        "#",         40),
            ("referencia", "Referência", 110),
            ("descricao",  "Descrição",  170),
            ("total_pecas","Peças",       70),
        ]
