...
from views.widgets import Card, StatCard, PrimaryBtn, SecondaryBtn, build_treeview
...
class DashboardView(tk.Frame):
    ...
    def _build(self):
        ...
        # fallback seguro: se existir nova_producao usa, senão novo_pedido
        acao_novo = getattr(self.app, "nova_producao", self.app.novo_pedido)
        PrimaryBtn(hdr, "＋  Novo pedido", command=acao_novo).pack(side="right")
        ...
        cols = [
            ("numero", "Número", 80),
            ("cliente_nome", "Cliente", 150),
            ("vendedor", "Vendedor", 110),
            ("total_valor", "Valor", 90),
            ("status", "Status", 100),
            ("dt_entrega", "Entrega", 85),
        ]
    ...
    def _configure_tree_columns(self):
        ...
        self._rec_tree.heading("vendedor", anchor="center")
        ...
        self._rec_tree.column("vendedor", anchor="center")
